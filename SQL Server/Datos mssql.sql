insert into tipoEmpleado (tipoEmpleado) values ('Mecánico'), ('Asesor de Servicios');
insert into departamento (departamento) values ('Servicio Técnico'), ('Servicio al Cliente');
