...
-- Empleados
INSERT INTO empleado (nombres,apellidos,dpi,fechaNacimiento,direccion,telefono,email, idTipoEmpleado, idDepartamento ,idEstado) VALUES ('Cristian','Juarez','21213654125', DATE '1995-06-22','7ma av 1-23 zona 3',42146214,'cristianjuarez@gmail.com', 1,  1, 1);
...
INSERT INTO cliente (nombres,apellidos,dpi,fechaNacimiento,direccion,telefono,email,nit,idEstado) VALUES ('Leticia','Campos','10101421452545', DATE '2001-01-12','2da calle',56565656,'leticampos@gmail.com','104752-5',1);
INSERT INTO cliente (nombres,apellidos,dpi,fechaNacimiento,direccion,telefono,email,nit,idEstado) VALUES ('Lucas','Rosales','222222222', DATE '1995-10-10','5 calle',52521414,'lucasrosales@gmail.com','261425-1',1);
INSERT INTO cliente (nombres,apellidos,dpi,fechaNacimiento,direccion,telefono,email,nit,idEstado) VALUES ('Daniela','Ramirez','3333333333', DATE '1999-03-15','6 alle',52523636,'daniroami@gmail.com','1842142-1',1);
INSERT INTO cliente (nombres,apellidos,dpi,fechaNacimiento,direccion,telefono,email,nit,idEstado) VALUES ('Mariela','Gomez','444444444444', DATE '1990-11-25','9 calle',56568585,'marielagomez@gmail.com','114714-1',1);
INSERT INTO cliente (nombres,apellidos,dpi,fechaNacimiento,direccion,telefono,email,nit,idEstado) VALUES ('Miguel','Marino','555555555555', DATE '1994-12-03','4 calle',44141414,'miguelmarino@gmail.com','465214-6',1);
INSERT INTO cliente (nombres,apellidos,dpi,fechaNacimiento,direccion,telefono,email,nit,idEstado) VALUES ('Angelica','Ramirez','7774758554522', DATE '2006-08-05','1 calle',51514141,'angelica@gmail.com','2914512-6',1);
INSERT INTO cliente (nombres,apellidos,dpi,fechaNacimiento,direccion,telefono,email,nit,idEstado) VALUES ('Luis','Fernandez','25245625625', DATE '2001-09-16','5 calle',53525154,'luisf@gmail.com','578458-6',1);
INSERT INTO cliente (nombres,apellidos,dpi,fechaNacimiento,direccion,telefono,email,nit,idEstado) VALUES ('Antonio','Quezada','254586552551', DATE '1992-12-12','2 calle',50125014,'antonio@gmail.com','5478541-6',1);
...
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (1, 1, 1, DATE '2024-02-01', '450.00');
-- Cambio de filtro de aire; precio 96.00; 
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (7, 1, 1, DATE '2024-02-01', '96.00');
-- Cambio de aceite de motor; precio 458.00; Aquí cambia el precio de este servicio
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (1, 1, 1, DATE '2024-02-15', '458.00');
-- Cambio de aceite de motor; precio 450.00; Aquí Cambia el precio de este servicio
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (1, 1, 1, DATE '2024-03-01', '450.00');
-- Cambio de aceite de motor; precio 475.00; Aquí cambia el precio de este servicio
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (1, 1, 1, DATE '2024-04-01', '475.00');


-- Versa 1.5L
-- Cambio de aceite de motor; precio 460.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (1, 2, 1, DATE '2024-02-01', '460.00'); 
-- Cambio de refrigerante; precio 650.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (4, 2, 1, DATE '2024-02-01', '100.00');
-- Revisión y ajuste de clutch; precio 100.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (10, 2, 1, DATE '2024-02-01', '100.00');

-- Corolla 1.8L
-- cambio de aceite de motor; precio 455.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (1, 4, 3, DATE '2024-02-01', '455.00');
-- Cambio de refrigerante; precio 100.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (4, 4, 3, DATE '2024-02-01', '100.00');
-- Cambio de bujias, modelo; precio 300.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (6, 4, 3, DATE '2024-02-01', '300.00');
-- Cambio de filtro de aire; precio 100.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (7, 4, 3, DATE '2024-02-01', '100.00');

-- Mazda3 2.0L
-- Cambio de aceite de motor; precio 675.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (1, 3, 4, DATE '2024-02-01', '675.00');
-- Cambio de refrigerante; precio 125.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (4, 3, 4, DATE '2024-02-01', '125.00');
-- Cambio de filtro de aire; precio 110.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (7, 3, 4, DATE '2024-02-01', '110.00'); 
-- Cambio de filtro de aceite; precio 125.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (3, 3, 4, DATE '2024-02-01', '125.00'); 
-- Cambio de bujías; precio 610.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (6, 3, 4, DATE '2024-02-01', '610.00'); 
-- Revisión y ajuste de clutch; precio 95.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (10, 3, 4, DATE '2024-02-01', '95.00');
-- Cambio de filtro de aire; precio 105.00; Aquí cambia el precio
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (7, 3, 4, DATE '2024-02-20', '105.00');

-- Mazda3 2.4L
-- Cambio de aceite de motor; precio 625.00
insert into precioServicio(idServicio, idModelo, idMotor, fechaInicioVigencia, precio) values (1, 3, 5, DATE '2024-02-01', '625.00');


-- Crea orden de servicio 1
insert into ordenServicio(fechaOrdenServicio, placa, kmActual, idEstadoOrden, idEmpleado) values (DATE '2024-02-05', 'P-256LRM', 50000, 1, 1);
-- Crea detalle de orden 1
insert into detalleOrden(idOrdenServicio, idServicio, cantidad) values (1, 1, 1);

-- Crea orden de servicio 2
insert into ordenServicio(fechaOrdenServicio, placa, kmActual, idEstadoOrden, idEmpleado) values (DATE '2024-02-06', 'P-128MHB', 80000, 1, 1);
...
insert into ordenServicio(fechaOrdenServicio, placa, kmActual, idEstadoOrden, idEmpleado) values (DATE '2024-02-08', 'P-120RAM', 30000, 1, 1);
...
insert into ordenServicio(fechaOrdenServicio, placa, kmActual, idEstadoOrden, idEmpleado) values (DATE '2024-02-20', 'P-175ALG', 30000, 1, 1);
...
insert into ordenServicio(fechaOrdenServicio, placa, kmActual, idEstadoOrden, idEmpleado) values (DATE '2024-03-05', 'P-240ABC', 26000, 1, 1);
...
insert into ordenServicio(fechaOrdenServicio, placa, kmActual, idEstadoOrden, idEmpleado) values (DATE '2024-02-14', 'P-741XYZ', 26000, 1, 1);
...
insert into ordenServicio(fechaOrdenServicio, placa, kmActual, idEstadoOrden, idEmpleado) values (DATE '2024-02-20', 'P-852GDC', 29500, 1, 1);
...
insert into ordenServicio(fechaOrdenServicio, placa, kmActual, idEstadoOrden, idEmpleado) values (DATE '2024-02-21', 'P-963JKL', 29300, 1, 1);
...
insert into ordenServicio(fechaOrdenServicio, placa, kmActual, idEstadoOrden, idEmpleado) values (DATE '2024-03-06', 'P-128MHB', 29600, 1, 1);
...
insert into ordenServicio(fechaOrdenServicio, placa, kmActual, idEstadoOrden, idEmpleado) values (DATE '2024-03-03', 'P-852GDC', 23000, 1, 1);
...
insert into ordenServicio(fechaOrdenServicio, placa, kmActual, idEstadoOrden, idEmpleado) values (DATE '2024-04-07', 'P-175ALG', 24000, 1, 1);
